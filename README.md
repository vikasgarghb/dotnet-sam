...
```bash
dotnet-sam$ sam logs -n HelloWorldFunction --stack-name dotnet-sam --tail
```
...
```bash
dotnet-sam$ dotnet test test/HelloWorld.Test
```
...
```bash
aws cloudformation delete-stack --stack-name dotnet-sam
```
